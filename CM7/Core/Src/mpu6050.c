...
static void i2c_MPU6050_write_reg(uint8_t *data, uint8_t num_of_data)
{
  // HAL Driver Usage //
    ...
    HAL_I2C_Mem_Write(&I2C_HANDLE, MPU6050_WRITE_ADDR, data[0], 1, data + 1, 1, HAL_I2C_TIMEOUT);
  #endif
...
{
  #ifdef MPU6050_USE_HAL
    HAL_I2C_Mem_Read(&I2C_HANDLE, MPU6050_WRITE_ADDR, command, 1, data, num_of_data, HAL_I2C_TIMEOUT);
  #endif
