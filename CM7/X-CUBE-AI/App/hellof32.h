/**
  ...
  ******************************************************************************
  */
#ifndef AI_HELLOF32_H
#define AI_HELLOF32_H

#include "hellof32_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_HELLOF32_MODEL_NAME          "hellof32"
#define AI_HELLOF32_ORIGIN_MODEL_NAME   "hello_world_float"

/******************************************************************************/
#define AI_HELLOF32_ACTIVATIONS_ALIGNMENT   (4)
#define AI_HELLOF32_INPUTS_IN_ACTIVATIONS   (4)
#define AI_HELLOF32_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_HELLOF32_IN_NUM        (1)

AI_DEPRECATED
#define AI_HELLOF32_IN \
  ai_hellof32_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_HELLOF32_IN_SIZE { \
  AI_HELLOF32_IN_1_SIZE, \
}
#define AI_HELLOF32_IN_SIZE_BYTES { \
  AI_HELLOF32_IN_1_SIZE_BYTES, \
}
#define AI_HELLOF32_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_HELLOF32_IN_1_CHANNEL     (1)
#define AI_HELLOF32_IN_1_SIZE        (1)
#define AI_HELLOF32_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_HELLOF32_OUT_NUM       (1)

AI_DEPRECATED
#define AI_HELLOF32_OUT \
  ai_hellof32_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_HELLOF32_OUT_SIZE { \
  AI_HELLOF32_OUT_1_SIZE, \
}
#define AI_HELLOF32_OUT_SIZE_BYTES { \
  AI_HELLOF32_OUT_1_SIZE_BYTES, \
}
#define AI_HELLOF32_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_HELLOF32_OUT_1_CHANNEL     (1)
#define AI_HELLOF32_OUT_1_SIZE        (1)
#define AI_HELLOF32_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_HELLOF32_N_NODES (5)
 ...
 * @ref ai_hellof32_create. Both the activations memory buffer 
 ...
 * using @ref ai_hellof32_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_hellof32_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_hellof32_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_HELLOF32_*
 * defines into file @ref hellof32.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
