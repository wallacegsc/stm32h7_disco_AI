...
/******************************************************************************/
#define AI_HELLOI8_MODEL_NAME          "helloi8"
#define AI_HELLOI8_ORIGIN_MODEL_NAME   "hello_world_int8"

/******************************************************************************/
#define AI_HELLOI8_ACTIVATIONS_ALIGNMENT   (4)
#define AI_HELLOI8_INPUTS_IN_ACTIVATIONS   (4)
#define AI_HELLOI8_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_HELLOI8_IN_NUM        (1)

AI_DEPRECATED
#define AI_HELLOI8_IN \
  ai_helloi8_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_HELLOI8_IN_SIZE { \
  AI_HELLOI8_IN_1_SIZE, \
}
#define AI_HELLOI8_IN_SIZE_BYTES { \
  AI_HELLOI8_IN_1_SIZE_BYTES, \
}
#define AI_HELLOI8_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_HELLOI8_IN_1_CHANNEL     (1)
#define AI_HELLOI8_IN_1_SIZE        (1)
#define AI_HELLOI8_IN_1_SIZE_BYTES  (1)

/******************************************************************************/
#define AI_HELLOI8_OUT_NUM       (1)

AI_DEPRECATED
#define AI_HELLOI8_OUT \
  ai_helloi8_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_HELLOI8_OUT_SIZE { \
  AI_HELLOI8_OUT_1_SIZE, \
}
#define AI_HELLOI8_OUT_SIZE_BYTES { \
  AI_HELLOI8_OUT_1_SIZE_BYTES, \
}
#define AI_HELLOI8_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_HELLOI8_OUT_1_CHANNEL     (1)
#define AI_HELLOI8_OUT_1_SIZE        (1)
#define AI_HELLOI8_OUT_1_SIZE_BYTES  (1)

/******************************************************************************/
#define AI_HELLOI8_N_NODES (3)
 ...
 */
AI_API_ENTRY
ai_error ai_helloi8_get_error(ai_handle network);
 ...
 */
AI_API_ENTRY
ai_handle ai_helloi8_destroy(ai_handle network);
 ...
 * @ref ai_helloi8_create. Both the activations memory buffer 
 ...
 * using @ref ai_helloi8_get_error
 */
AI_API_ENTRY
ai_bool ai_helloi8_init(
 ...
 */
AI_API_ENTRY
ai_error ai_helloi8_create_and_init(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_helloi8_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_helloi8_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_HELLOI8_*
 * defines into file @ref helloi8.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
